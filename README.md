...
### Nginx VM ###
  config.vm.define "web01" do |web01|   # name of the vm
    web01.vm.box = "ubuntu/bionic64"   # os used in the vm
...
### DB vm  ####
  ...
  config.vm.boot_timeout = 600   # increase the vagrant up timeout period
end
```
